...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.NordeaOpenBankingApi.AccountDetails2 = factory(root.NordeaOpenBankingApi.ApiClient, root.NordeaOpenBankingApi.AccountNumber, root.NordeaOpenBankingApi.BankInfo, root.NordeaOpenBankingApi.Link);
  }
  ...
  /**
   * The AccountDetails2 model module.
   * @module model/AccountDetails2
   * @version 2.2
   */

  /**
   * Constructs a new <code>AccountDetails2</code>.
   * @alias module:model/AccountDetails2
   * @class
   * @param id {String} 
   * @param accountName {String} 
   * @param accountNumber {module:model/AccountNumber} 
   * @param accountNumbers {Array.<module:model/AccountNumber>} 
   * @param accountType {module:model/AccountDetails2.AccountTypeEnum} 
   ...
   * @param status {module:model/AccountDetails2.StatusEnum} 
   */
  ...
  /**
   * Constructs a <code>AccountDetails2</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AccountDetails2} obj Optional instance to populate.
   * @return {module:model/AccountDetails2} The populated <code>AccountDetails2</code> instance.
   */
  ...
  /**
   * @member {module:model/AccountDetails2.AccountTypeEnum} accountType
   */
  ...
  /**
   * @member {module:model/AccountDetails2.StatusEnum} status
   */
